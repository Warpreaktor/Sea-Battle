...
public abstract class Player {
    ...
    public static String[] CPUKilledReplicas = {"Отдать концы...", "Он принял слишком \nмного рома на борт.",
            "Это был мой самый \nлюбимый корабль!", "Ты за это заплатишь!", "Ооо нееет!", "Встретимся в аду...",
            "[РЫДАЕТ]>", "Ты слишком жесток, \nдаже для пирата.", "Что я скажу их семьям? \nАх да, у них нет семей! ",
            "Вы храбро сражались."};

    public static String[] humanKilledReplicas = {"Катись к Дэви Джонсу!", "Отправим их в пучину!",
            "Пустил пузыри! Ха-ха!", "Рыбам на корм!", "Одним меньше.", "Аррр! Карамба!",
            "Теперь твой дом на дне.>", "Прогуляйся по доске!", "Морской чёрт тебе товарищь!",
            "Убиииит! Хаа!"};

    public static String[] CPUMissedReplicas = {"Эй! Здесь должен был \nбыть твой корабль!", "Аррр!",
            "Арргх! \nЯкорь мне в печень!", "Трусливый щенок! \nГде ты?!", "Я тебя найду!", "[ВСПЛЕСК ВОДЫ]",
            "Он только что был здесь!", "Покажись!", "Это был стратегически \nважный выстрел!", "...я же сказал стреляй левее!"};

    public static String[] humanMissedReplicas = {"У тебя там штурман запил?", "ХА-ХА!",
            "Считай бакланов дальше!", "Греби тем же курсом!", "Ух! Это было близко!", "[КРИК ЧАЕК]",
            "Стратегически важный выстрел?", ".....", ".....", "....."};

    public static String[] humanDamagedReplicas = {"На абордаж!", "Вот вам сухопутные крысы!",
            "Пленных не брать!", "Сойтись якорями!", "Му-а-а-а-ха-ха!", "Так держать!",
            "Ах вот ты где!", "Фортуна на моей стороне", "Сдавайся!", "Попал под раздачу!"};

    public static String[] CPUDamagedReplicas = {"Ах ты портовая крыса!", "Пол-у-у-нд-р-р-а!",
            "Три тысячи чертей! \nКак ты меня нашёл?", "Разрази меня гром!", "Проклятье", "Чтоб тебя разорвало!",
            "[ТРЕСЬК! ХРУСТЬ!]", "Ах ты морской чёрт!", "Пёс!", "Свистать всех на верх!"};
